    ...
    private void identificarHuella() {
        try {
            ...
            for (int i = 0; i < iteracciones; i++) {
                ...
                for (JsonElement jsonElement : list) {
                    ...
                    System.out.println("iteracciones: " + iteracciones);
                     System.out.println("datos " + jsonObject);
                    ...
                    if (resultado.isVerified()) {
                        ...
                        //tipodocumento = jsonObject.get("tipodocumento").getAsString();
                        //documento = jsonObject.get("documento").getAsString();
                        //nombres = jsonObject.get("nombres").getAsString();
                        //apellidos = jsonObject.get("apellidos").getAsString();
                        dedo = jsonObject.get("id_dedo").getAsString();
                        String data1 = new Gson().toJson(jsonObject);
                        data = data1;
                        flag = true;
                        break;
                    }
            ...
            if (mensaje.contains("no existe")) {
                ...
                //fingerTemp.setNombre(nombres);
                //fingerTemp.setApellido(apellidos);
                //fingerTemp.setTipoDocumento(tipodocumento);
                //fingerTemp.setDocumento(documento);
                fingerTemp.setDedo(dedo);
                fingerTemp.setData(data);
